...
from Benchmark.MADDPGC.rnn_gumbel_rnnq.config import *
from Benchmark.MADDPGC.rnn_gumbel_rnnq.agents import *
from Benchmark.MADDPGC.rnn_gumbel_rnnq.test import *
...
def train(ckpt_dir, restore_ckpt, sum_dir, ds_order):
    ...
    env = Calendar('human', 'robot', STEP_REWARD, FAIL_REWARD, REWARD, NUM_SLOTS,
                   dataset_path_prefix='utils/calendar_8_{}'.format(ds_order)) # /home/Datasets/Calendar # utils
