...
class ReplayBuffer(object):
    def __init__(self, size, num_agents, max_traj_len):
        ...
        self._storage = [OrderedDict() for _ in range(num_agents)]
        for i in range(num_agents):
            self._storage[i]['private'] = []
            self._storage[i]['last_actions'] = []
            self._storage[i]['actions'] = []
            self._storage[i]['rewards'] = []
            self._storage[i]['terminal'] = []
    ...
    def _process_traj(self, private, last_action, action, rewards, terminal):
        ...
        try:
            ...
            print(self.max_traj_len, len(private))
