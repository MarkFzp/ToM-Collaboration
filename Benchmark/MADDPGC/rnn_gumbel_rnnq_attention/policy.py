...
from Benchmark.MADDPGC.rnn_gumbel_rnnq_attention.buffer import ReplayBuffer
...
class Policy:
    ...
    def _build_net(self, inp, act_dim, num_units):
        ...
        for i in range(self.K):
            ...
            q_input = tf.concat([p_input]+[tf.gather(action_tensor, act) if i!=self.agent_index else
                                           act_sample_cont
